        ...
        expect(fixture).toHaveXML(xmlString([
          '<g gl-width="700" gl-height="250" class="gl-vgroup" split="15,60,10,15">',
            ...
            '<g gl-width="700" gl-height="150" transform="translate(0,37)">',
              ...
              '<g gl-padding="1" gl-padding-bottom="0" gl-width="686" gl-height="147" transform="translate(7,1.5)" class="gl-unframed">',
                '<rect class="gl-layout-size" width="686" height="147" fill="none"/>',
                '<g gl-width="686" gl-height="147" class="gl-framed">',
                  '<rect class="gl-layout-size" width="686" height="147" fill="none"/>',
                '</g>',
              '</g>',
            '</g>',
