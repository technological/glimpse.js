      ...
      it('renders default layout template', function () {
        ...
        expect(fixture).toHaveXML(xmlString([
          '<g gl-width="700" gl-height="250" class="gl-vgroup" split="15,60,10,15">',
            ...
            '</g>',
            '</g>',
            '<g gl-width="700" gl-height="150" gl-border-color="#999" gl-border-style="solid"',
            ' gl-border-width="1,1,1,1" gl-background-color="#fff" transform="translate(0,37)">',
            '<rect class="gl-layout-size" width="700" height="150" fill="#fff" stroke="#999"',
            ' stroke-width="1" stroke-dasharray="700,0,150,0,700,0,150"/>',
            ...
            '</g>',
            '</g>',
            '<g gl-width="700" gl-height="37.5" gl-border-color="#999"',
            ' gl-border-style="dotted" gl-border-width="1,0,0,0" transform="translate(0,212)">',
            '<rect class="gl-layout-size" width="700" height="37.5" fill="none"/>',
            '<line x1="0" y1="0" x2="700" y2="0" class="gl-dotted-border-top gl-line-border" stroke="#999"',
            ' stroke-width="1" stroke-dasharray="1,1"/>',
            '<g gl-padding="1" gl-padding-top="1" gl-padding-bottom="1" gl-width="686" gl-height="35.519999999999996"',
            ' transform="translate(7,0.74)" class="gl-footer">',
